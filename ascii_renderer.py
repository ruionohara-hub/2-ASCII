...
def ascii_to_image(ascii_text, color_data, font_size=10, bg_color=(0, 0, 0), font_path=None,
    ...
    if not font_path:
        ...
        print("警告: 等幅フォントが見つからず、Pillow deデフォルトフォントを使用します。")
    else:
    ...
    if char_pixel_width <= 0: char_pixel_width = max(1, int(font_size*0.6))
